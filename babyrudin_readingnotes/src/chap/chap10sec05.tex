...
\begin{myDef}
    \textbf{\color{blue} Basic $k$-forms}
...
may thus be a sum of several of the coefficients that occur in (\ref{10.34}).]
...
\begin{myDef}
    \textbf{\color{blue} Products of basic $k$-forms}
    Suppose 
    \begin{equation}
        \label{eq:10.51}
        I = \{i_1,...,i_p\},
...
\begin{myDef}
    \textbf{\color{blue} Multiplication}
...
\begin{myDef}
    \textbf{\color{blue} Differentiation}
