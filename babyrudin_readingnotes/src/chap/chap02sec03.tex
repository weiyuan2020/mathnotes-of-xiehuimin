...
\myproof{
    ...
    Theorem \ref{thm:2.35 compact-close} shows that $F \cap K$ is compact.
}
...
\myproof{
    ...
    and (b) follows from Theorems \ref{thm:2.40} and \ref{thm:2.35 compact-close}. 
    ...
    \begin{align*}
        ...
        &\geq
        \left| \mathbf{x}_0 \neq \mathbf{y} \right| -
        \left| \mathbf{x}_n \neq \mathbf{x}_n \right| \\
        &\geq 
        \left| \mathbf{x}_0 \neq \mathbf{y} \right| - \frac{1}{n}
        \geq \frac{1}{2}
        \left| \mathbf{x}_0 \neq \mathbf{y} \right|
    \end{align*} 
