...
\begin{myDef}\label{myDef:1.27}
    $i=(0,1)$    
\end{myDef}

\begin{thm}\label{thm:1.28}
    % 1.28 Theorem
    $i^2=-1$
\end{thm}
...
part (d) of Theorem \ref{thm:1.31}.
