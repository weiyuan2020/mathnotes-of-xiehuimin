...
\begin{myDef}
    \label{myDef:2.4 finite_countable}
...
\begin{myDef}\label{myDef:2.7 sequence}
    $f(x)$, $x\in J = \mathbb{N}^+$.\\
    $\{x_n\}$, $x_1,x_2,x_3,...$\\
...
\begin{thm}\label{thm:2.8 coubtable subset}
