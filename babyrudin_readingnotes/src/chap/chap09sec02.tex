...
\begin{thm}
    \label{thm:9.12}
    Suppose $E$ and $\mathbf{f}$ are as in Definition \ref{def:9.11}, 
...
\begin{myRemark}
    \begin{asparaenum}[(a)]
        ...
        \item Suppose $\mathbf{f}$ and $E$ are as in Definition \ref{def:9.11}, and $\mathbf{f}$ is differentiable in $E$. 
...
of Definition \ref{def:9.11} ; see Exercises 6 and 14, and Theorem \ref{thm:9.21}.
